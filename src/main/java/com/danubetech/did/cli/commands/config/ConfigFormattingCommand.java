...
@CommandLine.Command(
        name = "formatting",
        description = "Get or set the display of the API requests and responses. Default value: " + Formatting.DEFAULT_FORMATTING + ".",
...
public class ConfigFormattingCommand extends ConfigAbstractCommand implements Callable<Integer> {
    ...
    @CommandLine.Parameters(
            index = "0",
            description = "The display of the API requests and responses. Valid values: ${COMPLETION-CANDIDATES}. Default value: " + Formatting.DEFAULT_FORMATTING + ".",
            arity = "0..1"
    )
