...
import com.danubetech.did.cli.config.Endpoint;
...
@CommandLine.Command(
        name = "endpoint",
        description = "Get or set the endpoint URL of the API. Default value: " + Endpoint.DEFAULT_ENDPOINT + ".",
...
public class ConfigEndpointCommand extends ConfigAbstractCommand implements Callable<Integer> {
    ...
    @CommandLine.Parameters(
            index = "0",
            description = "The endpoint URL of the API. Default value: " + Endpoint.DEFAULT_ENDPOINT + ".",
            arity = "0..1"
    )
    String endpoint;
