...
import com.danubetech.did.api.client.openapi.model.DeactivateResourceRequest;
...
public class DeactivateResourceCommand extends DIDAbstractCommand implements Callable<Integer> {
