...
import com.danubetech.did.api.client.openapi.model.DeactivateRequest;
...
public class DeactivateCommand extends DIDAbstractCommand implements Callable<Integer> {
